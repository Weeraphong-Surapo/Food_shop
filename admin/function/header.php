...
<html>
  <head>
    ...
    <title>ระบบจัดการขายอาหาร</title>
            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between w-100">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a class="navbar-brand d-none d-sm-inline-block" href="index.php">
                  <div class="brand-text d-none d-lg-inline-block"><span>ระบบบริหารร้าน </span><strong></strong></div>
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <!-- Notifications-->
                <!-- Logout    -->
                <li class="nav-item"><a class="nav-link text-white" href="../index.php"> <span class="d-none d-sm-inline">ออกจากระบบ</span>
